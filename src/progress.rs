...
impl ProgressTracker {
    ...
    pub fn init(&self, targets: usize, templates: usize) {
        ...
        main_bar.set_message(format!("Scanning {} targets × {} templates", targets, templates));
    ...
    pub fn add_findings(&self, count: usize) {
        ...
        let new_count = self.findings_count.fetch_add(count as u64, Ordering::Relaxed) + count as u64;
