...
impl PatternRegistry {
    ...
    pub fn get_patterns(&self, language: TemplateLanguage, category: PatternCategory) -> &[ValidationPattern] {
        self.patterns
            .get(&language)
    ...
    pub fn has_any_match(&self, code: &str, language: TemplateLanguage, category: PatternCategory) -> bool {
    ...
    pub fn get_matches(&self, code: &str, language: TemplateLanguage, category: PatternCategory) -> Vec<&ValidationPattern> {
        self.get_patterns(language, category)
            .iter()
    ...
    fn add_patterns(&mut self, language: TemplateLanguage, category: PatternCategory, patterns: Vec<ValidationPattern>) {
        self.patterns
            .entry(language)
    ...
    fn register_python_patterns(&mut self) {
        // Network imports
        self.add_patterns(TemplateLanguage::Python, PatternCategory::NetworkImport, vec![
        ...
        // JSON imports
        self.add_patterns(TemplateLanguage::Python, PatternCategory::JsonImport, vec![
        ...
        // JSON output
        self.add_patterns(TemplateLanguage::Python, PatternCategory::JsonOutput, vec![
        ...
        // Error handling
        self.add_patterns(TemplateLanguage::Python, PatternCategory::ErrorHandling, vec![
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::Python, PatternCategory::TimeoutHandling, vec![
        ...
        // Entry point
        self.add_patterns(TemplateLanguage::Python, PatternCategory::EntryPoint, vec![
            ValidationPattern::literal("def main(", "main function")
                .with_suggestion("def main():\n    pass\n\nif __name__ == '__main__':\n    main()"),
            ValidationPattern::literal("if __name__ == '__main__'", "main guard"),
            ValidationPattern::literal("if __name__ == \"__main__\"", "main guard"),
        ]);

        // Environment variable access
        self.add_patterns(TemplateLanguage::Python, PatternCategory::EnvVarAccess, vec![
        ...
        self.add_patterns(TemplateLanguage::Python, PatternCategory::CommandExecution, vec![
        ...
        self.add_patterns(TemplateLanguage::Python, PatternCategory::FilePathOps, vec![
        ...
        // Unsafe functions
        self.add_patterns(TemplateLanguage::Python, PatternCategory::UnsafeFunctions, vec![
        ...
        // Comments
        self.add_patterns(TemplateLanguage::Python, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("#", "single line comment"),
        ]);
        self.add_patterns(TemplateLanguage::Python, PatternCategory::CommentMultiStart, vec![
    ...
    fn register_javascript_patterns(&mut self) {
        // Network imports
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::NetworkImport, vec![
        ...
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::JsonImport, vec![
            ValidationPattern::literal("JSON", "JSON global object"),
        ]);

        // JSON output
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::JsonOutput, vec![
            ValidationPattern::literal("JSON.stringify", "JSON serialization")
                .with_suggestion("console.log(JSON.stringify(findings));"),
            ValidationPattern::regex(r"console\.log\s*\(\s*JSON\.stringify", "JSON console output"),
        ]);

        // Error handling
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::ErrorHandling, vec![
            ValidationPattern::literal("try {", "try block")
                .with_suggestion("try {\n  // code\n} catch (e) {\n  // handle error\n}"),
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::TimeoutHandling, vec![
        ...
        // Entry point
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::EntryPoint, vec![
        ...
        // Environment variable access
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::EnvVarAccess, vec![
            ValidationPattern::literal("process.env", "environment access")
                .with_suggestion("process.env.CERT_X_GEN_TARGET_HOST"),
        ]);

        // Command execution (security)
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::CommandExecution, vec![
        ...
        // File path operations
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::FilePathOps, vec![
        ...
        // Unsafe functions
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::UnsafeFunctions, vec![
            ValidationPattern::regex(r"eval\s*\(", "eval - dangerous"),
        ...
        // Comments
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("//", "single line comment"),
        ]);
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::CommentMultiStart, vec![
            ValidationPattern::literal("/*", "multi-line comment start"),
        ]);
        self.add_patterns(TemplateLanguage::JavaScript, PatternCategory::CommentMultiEnd, vec![
            ValidationPattern::literal("*/", "multi-line comment end"),
        ]);
    }
    ...
    fn register_rust_patterns(&mut self) {
        // Network imports
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::NetworkImport, vec![
        ...
        // JSON imports
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::JsonImport, vec![
        ...
        // JSON output
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::JsonOutput, vec![
        ...
        // Error handling
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::ErrorHandling, vec![
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::TimeoutHandling, vec![
        ...
        // Entry point
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::EntryPoint, vec![
            ValidationPattern::literal("fn main()", "main function")
                .with_suggestion("fn main() -> Result<(), Box<dyn std::error::Error>> {\n    Ok(())\n}"),
        ...
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::PackageDeclaration, vec![]);

        // Environment variable access
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::EnvVarAccess, vec![
        ...
        // Command execution
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::CommandExecution, vec![
        ...
        // Unsafe functions
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::UnsafeFunctions, vec![
        ...
        // Comments
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("//", "single line comment"),
        ]);
        self.add_patterns(TemplateLanguage::Rust, PatternCategory::CommentMultiStart, vec![
            ValidationPattern::literal("/*", "multi-line comment start"),
        ]);
    }
    ...
    fn register_go_patterns(&mut self) {
        // Network imports
        self.add_patterns(TemplateLanguage::Go, PatternCategory::NetworkImport, vec![
        ...
        // JSON imports
        self.add_patterns(TemplateLanguage::Go, PatternCategory::JsonImport, vec![
            ValidationPattern::literal("\"encoding/json\"", "encoding/json package")
                .with_suggestion("import \"encoding/json\""),
        ]);

        // JSON output
        self.add_patterns(TemplateLanguage::Go, PatternCategory::JsonOutput, vec![
        ...
        // Error handling
        self.add_patterns(TemplateLanguage::Go, PatternCategory::ErrorHandling, vec![
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::Go, PatternCategory::TimeoutHandling, vec![
            ValidationPattern::literal("context.WithTimeout", "context timeout")
                .with_suggestion("ctx, cancel := context.WithTimeout(context.Background(), 10*time.Second)"),
        ...
        // Entry point
        self.add_patterns(TemplateLanguage::Go, PatternCategory::EntryPoint, vec![
            ValidationPattern::literal("func main()", "main function")
                .with_suggestion("func main() {\n}"),
        ]);

        // Package declaration
        self.add_patterns(TemplateLanguage::Go, PatternCategory::PackageDeclaration, vec![
            ValidationPattern::literal("package main", "package main")
                .with_suggestion("package main"),
        ]);

        // Environment variable access
        self.add_patterns(TemplateLanguage::Go, PatternCategory::EnvVarAccess, vec![
        ...
        // Command execution
        self.add_patterns(TemplateLanguage::Go, PatternCategory::CommandExecution, vec![
            ValidationPattern::literal("exec.Command(", "exec.Command"),
            ValidationPattern::literal("os/exec", "os/exec package"),
        ]);

        // Unsafe functions
        self.add_patterns(TemplateLanguage::Go, PatternCategory::UnsafeFunctions, vec![
            ValidationPattern::literal("unsafe.", "unsafe package"),
            ValidationPattern::literal("panic(", "panic"),
        ]);

        // Comments
        self.add_patterns(TemplateLanguage::Go, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("//", "single line comment"),
        ]);
        self.add_patterns(TemplateLanguage::Go, PatternCategory::CommentMultiStart, vec![
            ValidationPattern::literal("/*", "multi-line comment start"),
        ]);
    }
    ...
    fn register_c_patterns(&mut self) {
        // Network imports
        self.add_patterns(TemplateLanguage::C, PatternCategory::NetworkImport, vec![
        ...
        // JSON imports
        self.add_patterns(TemplateLanguage::C, PatternCategory::JsonImport, vec![
        ...
        // JSON output
        self.add_patterns(TemplateLanguage::C, PatternCategory::JsonOutput, vec![
        ...
        // Error handling
        self.add_patterns(TemplateLanguage::C, PatternCategory::ErrorHandling, vec![
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::C, PatternCategory::TimeoutHandling, vec![
            ValidationPattern::literal("setsockopt(", "setsockopt")
                .with_suggestion("setsockopt(sock, SOL_SOCKET, SO_RCVTIMEO, &timeout, sizeof(timeout));"),
        ...
        // Entry point
        self.add_patterns(TemplateLanguage::C, PatternCategory::EntryPoint, vec![
        ...
        // Environment variable access
        self.add_patterns(TemplateLanguage::C, PatternCategory::EnvVarAccess, vec![
            ValidationPattern::literal("getenv(", "getenv")
                .with_suggestion("getenv(\"CERT_X_GEN_TARGET_HOST\")"),
        ]);

        // Command execution
        self.add_patterns(TemplateLanguage::C, PatternCategory::CommandExecution, vec![
        ...
        // Unsafe functions
        self.add_patterns(TemplateLanguage::C, PatternCategory::UnsafeFunctions, vec![
            ...
            ValidationPattern::regex(r#"printf\s*\(\s*[^"]"#, "printf without format - dangerous"),
        ]);

        // Comments
        self.add_patterns(TemplateLanguage::C, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("//", "single line comment"),
        ]);
        self.add_patterns(TemplateLanguage::C, PatternCategory::CommentMultiStart, vec![
            ValidationPattern::literal("/*", "multi-line comment start"),
        ]);
    }
    ...
    fn register_cpp_patterns(&mut self) {
        ...
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::NetworkImport, vec![
            ValidationPattern::literal("#include <sys/socket.h>", "socket header")
                .with_suggestion("#include <sys/socket.h>"),
            ValidationPattern::literal("#include <netinet/in.h>", "network header"),
        ...
        // JSON imports
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::JsonImport, vec![
        ...
        // JSON output
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::JsonOutput, vec![
        ...
        // Error handling
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::ErrorHandling, vec![
            ValidationPattern::literal("try {", "try block")
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::TimeoutHandling, vec![
            ValidationPattern::literal("setsockopt(", "setsockopt"),
            ValidationPattern::literal("SO_RCVTIMEO", "receive timeout"),
        ...
        // Entry point
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::EntryPoint, vec![
            ValidationPattern::literal("int main(", "main function")
                .with_suggestion("int main(int argc, char* argv[]) {\n    return 0;\n}"),
            ValidationPattern::regex(r"int\s+main\s*\(", "main function"),
        ]);
        ...
        // Environment variable access
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::EnvVarAccess, vec![
        ...
        // Command execution
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::CommandExecution, vec![
            ValidationPattern::literal("system(", "system - unsafe"),
            ValidationPattern::literal("popen(", "popen"),
        ...
        // Unsafe functions
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::UnsafeFunctions, vec![
            ValidationPattern::literal("gets(", "gets - buffer overflow"),
            ValidationPattern::literal("strcpy(", "strcpy - use strncpy"),
            ValidationPattern::literal("sprintf(", "sprintf - use snprintf"),
        ...
        // Comments (same as C)
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("//", "single line comment"),
        ]);
        self.add_patterns(TemplateLanguage::Cpp, PatternCategory::CommentMultiStart, vec![
            ValidationPattern::literal("/*", "multi-line comment start"),
        ]);
    }
    ...
    fn register_java_patterns(&mut self) {
        // Network imports
        self.add_patterns(TemplateLanguage::Java, PatternCategory::NetworkImport, vec![
            ValidationPattern::literal("import java.net.Socket", "Socket import"),
            ValidationPattern::literal("import java.net.HttpURLConnection", "HttpURLConnection"),
        ...
        // JSON imports
        self.add_patterns(TemplateLanguage::Java, PatternCategory::JsonImport, vec![
        ...
        // JSON output
        self.add_patterns(TemplateLanguage::Java, PatternCategory::JsonOutput, vec![
        ...
        // Error handling
        self.add_patterns(TemplateLanguage::Java, PatternCategory::ErrorHandling, vec![
            ValidationPattern::literal("try {", "try block"),
            ValidationPattern::literal("catch (", "catch block"),
            ValidationPattern::literal("catch(", "catch block"),
            ValidationPattern::literal("finally {", "finally block"),
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::Java, PatternCategory::TimeoutHandling, vec![
        ...
        // Entry point
        self.add_patterns(TemplateLanguage::Java, PatternCategory::EntryPoint, vec![
        ...
        // Package declaration
        self.add_patterns(TemplateLanguage::Java, PatternCategory::PackageDeclaration, vec![
            ValidationPattern::literal("package ", "package declaration"),
            ValidationPattern::literal("public class ", "public class"),
        ]);

        // Environment variable access
        self.add_patterns(TemplateLanguage::Java, PatternCategory::EnvVarAccess, vec![
            ValidationPattern::literal("System.getenv(", "getenv"),
        ]);

        // Unsafe functions
        self.add_patterns(TemplateLanguage::Java, PatternCategory::UnsafeFunctions, vec![
            ValidationPattern::literal("Runtime.getRuntime().exec", "Runtime exec - command injection risk"),
            ValidationPattern::literal("ProcessBuilder", "ProcessBuilder - command execution"),
        ]);

        // Command execution
        self.add_patterns(TemplateLanguage::Java, PatternCategory::CommandExecution, vec![
            ValidationPattern::literal("Runtime.exec", "Runtime exec"),
            ValidationPattern::literal("ProcessBuilder", "ProcessBuilder"),
        ]);

        // Comments
        self.add_patterns(TemplateLanguage::Java, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("//", "single line comment"),
        ]);
        self.add_patterns(TemplateLanguage::Java, PatternCategory::CommentMultiStart, vec![
            ValidationPattern::literal("/*", "multi-line comment start"),
        ]);
    }
    ...
    fn register_ruby_patterns(&mut self) {
        // Network imports
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::NetworkImport, vec![
        ...
        // JSON imports
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::JsonImport, vec![
            ValidationPattern::literal("require 'json'", "json require"),
            ValidationPattern::literal("require 'oj'", "oj require (fast JSON)"),
        ]);

        // JSON output
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::JsonOutput, vec![
        ...
        // Error handling
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::ErrorHandling, vec![
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::TimeoutHandling, vec![
        ...
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::EntryPoint, vec![
        ...
        // Environment variable access
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::EnvVarAccess, vec![
            ValidationPattern::literal("ENV[", "ENV hash"),
            ValidationPattern::literal("ENV.fetch", "ENV.fetch"),
        ]);

        // Unsafe functions
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::UnsafeFunctions, vec![
        ...
        // Command execution
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::CommandExecution, vec![
        ...
        // Comments
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("#", "single line comment"),
        ]);
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::CommentMultiStart, vec![
            ValidationPattern::literal("=begin", "multi-line comment start"),
        ]);
        self.add_patterns(TemplateLanguage::Ruby, PatternCategory::CommentMultiEnd, vec![
            ValidationPattern::literal("=end", "multi-line comment end"),
        ]);
    }
    ...
    fn register_perl_patterns(&mut self) {
        // Network imports
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::NetworkImport, vec![
        ...
        // JSON imports
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::JsonImport, vec![
            ValidationPattern::literal("use JSON", "JSON module")
                .with_suggestion("use JSON;"),
        ...
        // JSON output
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::JsonOutput, vec![
        ...
        // Error handling
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::ErrorHandling, vec![
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::TimeoutHandling, vec![
            ValidationPattern::literal("Timeout =>", "timeout option")
        ...
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::EntryPoint, vec![
            ValidationPattern::literal("#!/usr/bin/perl", "perl shebang"),
            ValidationPattern::literal("#!/usr/bin/env perl", "env perl shebang"),
        ]);

        // Package declaration
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::PackageDeclaration, vec![
        ...
        // Environment variable access
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::EnvVarAccess, vec![
            ValidationPattern::literal("$ENV{", "ENV hash")
                .with_suggestion("$ENV{'CERT_X_GEN_TARGET_HOST'}"),
        ]);

        // Command execution
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::CommandExecution, vec![
            ValidationPattern::literal("system(", "system - command execution"),
            ValidationPattern::literal("`", "backticks - command execution"),
        ...
        // Unsafe functions
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::UnsafeFunctions, vec![
        ...
        // Comments
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("#", "single line comment"),
        ]);
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::CommentMultiStart, vec![
            ValidationPattern::literal("=pod", "POD start"),
            ValidationPattern::literal("=head", "POD heading"),
        ]);
        self.add_patterns(TemplateLanguage::Perl, PatternCategory::CommentMultiEnd, vec![
            ValidationPattern::literal("=cut", "POD end"),
        ]);
    }
    ...
    fn register_php_patterns(&mut self) {
        ...
        self.add_patterns(TemplateLanguage::Php, PatternCategory::NetworkImport, vec![
        ...
        self.add_patterns(TemplateLanguage::Php, PatternCategory::JsonImport, vec![
            ValidationPattern::literal("json_", "JSON functions available"),
        ]);

        // JSON output
        self.add_patterns(TemplateLanguage::Php, PatternCategory::JsonOutput, vec![
        ...
        // Error handling
        self.add_patterns(TemplateLanguage::Php, PatternCategory::ErrorHandling, vec![
            ValidationPattern::literal("try {", "try block")
                .with_suggestion("try {\n    // code\n} catch (Exception $e) {\n    // handle\n}"),
            ValidationPattern::literal("catch (", "catch block"),
            ValidationPattern::literal("finally {", "finally block"),
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::Php, PatternCategory::TimeoutHandling, vec![
        ...
        // Entry point
        self.add_patterns(TemplateLanguage::Php, PatternCategory::EntryPoint, vec![
            ValidationPattern::literal("<?php", "PHP opening tag")
                .with_suggestion("<?php\n"),
            ValidationPattern::literal("<?=", "PHP short echo tag"),
        ]);

        // Shebang
        self.add_patterns(TemplateLanguage::Php, PatternCategory::Shebang, vec![
            ValidationPattern::literal("#!/usr/bin/php", "PHP shebang"),
            ValidationPattern::literal("#!/usr/bin/env php", "env PHP shebang"),
        ]);

        // Environment variable access
        self.add_patterns(TemplateLanguage::Php, PatternCategory::EnvVarAccess, vec![
            ValidationPattern::literal("getenv(", "getenv")
                .with_suggestion("getenv('CERT_X_GEN_TARGET_HOST')"),
        ...
        // Command execution
        self.add_patterns(TemplateLanguage::Php, PatternCategory::CommandExecution, vec![
        ...
        // Unsafe functions
        self.add_patterns(TemplateLanguage::Php, PatternCategory::UnsafeFunctions, vec![
            ValidationPattern::literal("eval(", "eval - dangerous"),
        ...
        // Comments
        self.add_patterns(TemplateLanguage::Php, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("//", "single line comment"),
            ValidationPattern::literal("#", "shell-style comment"),
        ]);
        self.add_patterns(TemplateLanguage::Php, PatternCategory::CommentMultiStart, vec![
            ValidationPattern::literal("/*", "multi-line comment start"),
        ]);
        self.add_patterns(TemplateLanguage::Php, PatternCategory::CommentMultiEnd, vec![
            ValidationPattern::literal("*/", "multi-line comment end"),
        ]);
    }
    ...
    fn register_shell_patterns(&mut self) {
        ...
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::NetworkImport, vec![
            ValidationPattern::literal("nc ", "netcat")
                .with_suggestion("nc -z $HOST $PORT"),
        ...
        // JSON handling
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::JsonImport, vec![
            ValidationPattern::literal("jq ", "jq command"),
            ValidationPattern::literal("| jq", "jq pipe"),
        ]);

        // JSON output
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::JsonOutput, vec![
        ...
        // Error handling
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::ErrorHandling, vec![
        ...
        // Timeout handling
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::TimeoutHandling, vec![
        ...
        // Entry point (shebang)
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::EntryPoint, vec![
        ...
        // Shebang
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::Shebang, vec![
            ValidationPattern::literal("#!/bin/bash", "bash shebang"),
            ValidationPattern::literal("#!/bin/sh", "sh shebang"),
            ValidationPattern::literal("#!/usr/bin/env bash", "env bash"),
        ]);
        ...
        // Environment variable access
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::EnvVarAccess, vec![
        ...
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::CommandExecution, vec![
        ...
        // Unsafe patterns
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::UnsafeFunctions, vec![
            ValidationPattern::regex(r"eval\s+\$", "eval with variable - dangerous"),
        ...
        // Comments
        self.add_patterns(TemplateLanguage::Shell, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("#", "single line comment"),
        ]);
    }
    ...
    fn register_yaml_patterns(&mut self) {
        ...
        self.add_patterns(TemplateLanguage::Yaml, PatternCategory::NetworkImport, vec![
        ...
        // Comments
        self.add_patterns(TemplateLanguage::Yaml, PatternCategory::CommentSingle, vec![
            ValidationPattern::literal("#", "YAML comment"),
        ]);
    }
}
...
mod tests {
    ...
    fn test_registry_has_patterns() {
        ...
        let python_network = registry.get_patterns(TemplateLanguage::Python, PatternCategory::NetworkImport);
    ...
    fn test_has_any_match() {
        ...
        assert!(registry.has_any_match(code, TemplateLanguage::Python, PatternCategory::NetworkImport));
        assert!(registry.has_any_match(code, TemplateLanguage::Python, PatternCategory::JsonImport));
    }
